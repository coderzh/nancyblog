...
class BaseRequestHandler(webapp.RequestHandler):
    ...
    def template_render_theme(self, template_name, template_values={}):
        values = self.get_basic_template_values()
        directory = os.path.split(os.path.dirname(__file__))[0]
        template_path = os.path.join(directory, 'themes', values['bloginfo'].theme, template_name)

        blog_values = { 'tags' : Tag.get_all(),
